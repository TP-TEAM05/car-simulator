...
func generateNewData() ([]interface{}, error) {
	...
	for i := 0; i < 40; i++ {
		if previousJsonCar1 == (NewUpdateJson{}) {
			...
			vehicleJson := NewVehicle{
				...
				RearUltrasonic:     15,
				FrontLidar:         100.1,
				Speed:              previousJsonCar1.Vehicle.SpeedRearRight + speedIncrement,
			...
			vehicleJson = NewVehicle{
				...
				Speed:              previousJsonCar2.Vehicle.SpeedRearRight,
	...
	for i := 0; i < 9; i++ {
		...
		vehicleJson := NewVehicle{
			...
			RearUltrasonic:     15,
			FrontLidar:         100.1,
			Speed:              previousJsonCar1.Vehicle.SpeedRearRight,
